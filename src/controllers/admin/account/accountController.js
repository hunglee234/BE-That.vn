...
exports.createAccount = async (req, res) => {
  try {
    ...
    console.log("Lỗi khi tạo tài khoản khách hàng", error.message);
    return res.status(500).json({
      message: "Có lỗi khi tạo khách hàng, vui lòng thử lại sau!",
    });
  }
};

exports.getFullAccount = async (req, res) => {
  try {
    const userId = req.user.id;
    ...
    console.log("Lỗi khi lấy danh sách tài khoản khách hàng", error.message);
    return res.status(500).json({
      message:
        "Lỗi khi lấy danh sách tài khoản khách hàng, vui lòng thử lại sau!",
    });
  }
};
